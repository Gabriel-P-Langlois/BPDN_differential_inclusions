...
% The purpose of this experiment is to test whether it makes sense
% to just reduce the dimensionality of the equicorrelation set and work
% directly with this.

% If this is true, then there may be a computational hack to be found...

function [sol_x,sol_p,exact_path] = ...
    homotopy_exp_24_07_2024(A,b,m,n,tol,display_iterations,run_diagnostics)
