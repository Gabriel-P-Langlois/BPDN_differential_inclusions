...
while ((shall_continue && (nb_iteration <= 1000)))
    %%% 1. Compute direction
    tmp1 = K*x_nnls;                % Note: tmp1 = - A*x
    direction = minusb - tmp1;      % direction = A*x-b
