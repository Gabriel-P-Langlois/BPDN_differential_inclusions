function [sol_x,sol_p] = ...
    pseudo_exact_algorithm(A,b,tol,max_iter,disp_output_pseudo)
%% Description -- lasso_homotopy_solver_opt
% Inexact/greedy approach -- Written by Gabriel Provencher Langlois
...
while(shall_continue && k <= max_iter)
    ...
    % Compute thee `smallest' amount of time we can descent over
