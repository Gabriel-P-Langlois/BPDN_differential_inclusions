...
%
%   The matrix A is generated by sampling its columns uniformly from N(O,I)
%   and normalizing its column. The data vector b is generated uniformly
%   from N(0,I) as well.
%
%   Run from the project directory with
%   run ./results/1_calibration/run_dense_ex_1_2.m
