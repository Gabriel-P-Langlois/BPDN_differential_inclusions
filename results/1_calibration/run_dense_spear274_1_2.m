...
%   All default values are used for glmnet and mlasso, including their
%   tolerances (1e-04 for both). For FISTA, we use a tolerance of 
%   1e-03 and stop the algorithm whenever the relative difference 
%   in the dual updates are less than tol.
%
...
%   run ./results/1_calibration/run_dense_spear274_1_2.m


%% Initialization
% Filename
name = "dense_spear274_1_2";
...
%% Generate data
load './../../../LOCAL_DATA/l1_testset_data/spear_inst_274.mat'
[m,n] = size(A);
