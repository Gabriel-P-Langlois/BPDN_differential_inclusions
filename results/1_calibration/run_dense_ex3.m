...
%
%   We generate a random matrix A with m = 1024 rows and n = 2048 columns,
...
% run ./results/1_calibration/run_dense_ex2.m

% Note: Takes about 2 minutes to run on GPL's laptop.
