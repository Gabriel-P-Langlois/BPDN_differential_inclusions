...
%   Part 2/2.
%
%   This runs Algorithm 1-3, glmnet, mlass, fista.
%   This is the same as in Part 1/2, except the tolerances for glmnet,
%   fista and mlasso are harsher (1e-13, 1e-06, 1e-08).
%
...
%   run ./results/1_calibration/run_dense_ex_2_2.m
...
options = glmnetSet;
options.thresh = 1e-12; options.maxit = 10^5;
