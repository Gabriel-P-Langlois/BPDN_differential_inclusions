...
if(summarize_1_dense)
    ...
    if(~summarize_1_calculations)
        ...
        objd_mlasso = dual_obj_fun(sol_mlasso_p,t,b);
        ...
        rel_err_objd_mlasso_alg1 = ...
            abs(objd_mlasso-objd_alg1)./abs(objd_alg1);
        ...
        rel_err_dual_mlasso_alg1 = zeros(kmax,1);
        for k=1:1:kmax
    ...
    disp(['X = mlasso: ', ...
        num2str(min(rel_err_objd_mlasso_alg1(1:end-1)))])
    disp(['X = fista: ', ...
    ...
    loglog(t(1:end-1)/t0,rel_err_dual_glmnet_alg1(1:end-1),...
        'square','DisplayName','glmnet',...
        'MarkerFaceColor',RGB(1,:),'MarkerEdgeColor','k')
    loglog(t(1:end-1)/t0,rel_err_dual_mlasso_alg1(1:end-1),...
        'diamond','DisplayName','mlasso',...
        'MarkerFaceColor',RGB(4,:),'MarkerEdgeColor','k')
    ...
    semilogx(t(1:end-1)/t0,nnz_glmnet(1:end-1),'square','DisplayName','glmnet',...
        'MarkerFaceColor',RGB(1,:),'MarkerEdgeColor','k') 
    semilogx(t/t0,nnz_mlasso,'diamond','DisplayName','mlasso',...
        'MarkerFaceColor',RGB(4,:),'MarkerEdgeColor','k')
