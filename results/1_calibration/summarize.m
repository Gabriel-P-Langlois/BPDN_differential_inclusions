...
figure(1)
plot(t(1:end-1),Vprimal_incl(1:end-1),'-o','DisplayName','diff incl')
hold
plot(t(1:end-1),Vprimal_glmnet(1:end-1),'x','DisplayName','glmnet')

if(use_mlasso)
    Vprimal_mlasso = primal_obj_fun(sol_mlasso_x,t,A,b);
    plot(t(1:end-1),Vprimal_mlasso(1:end-1),'*','DisplayName','matlab lasso')
end
if(use_fista)
    Vprimal_fista = primal_obj_fun(sol_fista_x,t,A,b);
    plot(t(1:end-1),Vprimal_fista(1:end-1),'+','DisplayName','fista')
end
...
figure(2)
plot(t(1:end-1),Vdual_incl(1:end-1),'-o','DisplayName','diff incl')
hold
plot(t(1:end-1),Vdual_glmnet(1:end-1),'x','DisplayName','glmnet')

if(use_mlasso)
    Vdual_mlasso = dual_obj_fun(sol_mlasso_p,t,b);
    plot(t(1:end-1),Vdual_mlasso(1:end-1),'*','DisplayName','matlab lasso')
end
if(use_fista)
    Vdual_fista = dual_obj_fun(sol_fista_p,t,b);
    plot(t(1:end-1),Vdual_fista(1:end-1),'+','DisplayName','fista')
end
...
figure(3)
plot(t(1:end-1),norm_dual_glmnet_incl(1:end-1),'-o','DisplayName','GLMNET')
...
figure(4)
plot(t(1:end-1),norm_dual_fista_incl(1:end-1),'-o','DisplayName','FISTA')
...
figure(5)
plot(t(1:end-1),norm_dual_mlasso_incl(1:end-1),'-o','DisplayName','mlasso')
...
nnz_glmnet(kmax) = 0;
figure(6)
plot(t,nnz_incl,'-o','DisplayName','diff incl')
hold
plot(t,nnz_glmnet,'x','DisplayName','glmnet')
