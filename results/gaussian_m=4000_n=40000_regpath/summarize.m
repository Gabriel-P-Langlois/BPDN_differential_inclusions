...
if(summarize_4000_40000_regpath)
    ...
    disp('Rel. error in linf norm of the differences between primal solutions (glmnet/incl).')
    disp([norm_dual_glmnet_incl, norm_dual_fista_glmnet])

    disp('Rel. error in linf norm of the differences between dual solutions (glmnet/incl).')
    disp([norm_dual_glmnet_incl, norm_dual_fista_glmnet])
end